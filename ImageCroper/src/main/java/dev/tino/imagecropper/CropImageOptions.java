...
public class CropImageOptions implements Parcelable {
    ...
    public static final int IMAGE_ORIGIN_CAMERA = 1;
    public static final int IMAGE_ORIGIN_FILE = 2;
    public static final int IMAGE_ORIGIN_ALL = 3;
    ...
    /**
     * optional, allow take picture or select existing file or both
     */
    public int imageOrigin;
