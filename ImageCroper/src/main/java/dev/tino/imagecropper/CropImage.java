...
public final class CropImage {
     ...
     */
    public static void startPickImageActivity(@NonNull Activity activity, CropImageOptions options) {
        activity.startActivityForResult(
                getPickImageChooserIntent(activity, options), PICK_IMAGE_CHOOSER_REQUEST_CODE);
    }

    /**
     * Same as {@link #startPickImageActivity(Activity, CropImageOptions) startPickImageActivity} method but instead of
     ...
     */
    public static void startPickImageActivity(@NonNull Context context, CropImageOptions options, @NonNull Fragment fragment) {
        fragment.startActivityForResult(
                getPickImageChooserIntent(context, options), PICK_IMAGE_CHOOSER_REQUEST_CODE);
    }
     ...
     */
    public static Intent getPickImageChooserIntent(@NonNull Context context, CropImageOptions options) {
        return getPickImageChooserIntent(
                context, context.getString(R.string.pick_image_intent_chooser_title), false, true, options);
    }
        ...
        if (SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            try {
                outputFileUri = FileProvider.getUriForFile(
                        context,
                        context.getPackageName() + ".cropper.fileprovider",
    ...
    /**
     * Get the URI of the selected image from {@link #getPickImageChooserIntent(Context, CropImageOptions)}.<br>
     ...
     * Result will be received in {Activity#onActivityResult(int, int, Intent)} and can be
     ...
     * #activity(Uri)}.
     *
     * @param data result data intent as received in {Activity#onActivityResult(int, int,
     *             Intent)}.
    ...
    public static final class ActivityBuilder {
        ...
        /**
         * Set image origin: camera, file or both
         * <p>
         * default false
         *
         * @param imageOrigin
         * @return
         */
        public ActivityBuilder setImageOrigin(int imageOrigin) {
            mOptions.imageOrigin = imageOrigin;
            return this;
        }
    }
    // endregion
